...
export const NAV = [
  ...
  { path: '/channels/homecentre', id: 'homecentre', label: 'Home Centre', icon: '⇄', title: 'Home Centre (UAE + KSA)', region: 'gcc' },
  { path: '/channels/6thstreet', id: '6thstreet', label: '6th Street', icon: '◫', title: '6th Street (KSA)', region: 'gcc' },
  { path: '/channels', id: 'channels', label: 'All channels', icon: '⊞', title: 'Channel Operations' },

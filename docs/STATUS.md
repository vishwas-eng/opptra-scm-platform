...
A real end-to-end run needs a UC session pasted in Admin (or the whitelisted account), the only thing not doable from a dev machine. The code paths use the exact endpoints/payloads
